...
// */
//@Controller
//public class AddProductController0 {
//
...
//
//    public AddProductController0(PartService partService) {
...
//    @GetMapping("/boughtproduct1")
//    public String boughtProduct1(@RequestParam("productID") int theId, Model theModel) {
//        ProductService productService = context.getBean(ProductServiceImpl.class);
...
//                    "boughtproduct", "Purchase successful, you bought one product!");
//        } else {
//            theModel.addAttribute(
//                    "boughtproduct", "Purchase unsuccessful, product is out of stock!");
//        }
//        return "confirmationboughtoneproduct";
//    }
//
//
