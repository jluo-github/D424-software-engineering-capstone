...
public class PDFPartService {
  ...
  public void export(List<Part> partList, HttpServletResponse response) throws IOException {
    ...
    wirtePartHeader(table);
    writePartData(table, partList);
  ...
  private void writePartData(PdfPTable table, List<Part> partList) {
  ...
  private void wirtePartHeader(PdfPTable table) {
